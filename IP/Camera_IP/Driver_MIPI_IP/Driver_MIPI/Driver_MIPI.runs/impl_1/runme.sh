...
HD_PWD='C:/Users/Opex9020/Desktop/Test/IP/Camera_IP/Driver_MIPI_IP/Driver_MIPI/Driver_MIPI.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_MIPI.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Driver_MIPI.tcl -notrace

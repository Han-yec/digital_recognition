...
HD_PWD='C:/Users/Opex9020/Desktop/Test/IP/Camera_IP/Driver_MIPI_IP/Driver_MIPI/Driver_MIPI.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Driver_MIPI.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Driver_MIPI.tcl
